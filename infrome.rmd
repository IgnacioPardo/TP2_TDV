...
abstract: |
    ...
    Dos Heurísticas constructivas, dos operadores de busqueda local y una Metaheurística. El objetivo de este informe es el de detallar los algoritmos comparando calidad de resultados, tiempo de ejecución e implicancias prácticas en relación al problema que enfrenta la empresa ThunderPack.
output:
  pdf_document:
    toc: yes
    #toc_depth: 2
...
| G        | BP          | S(G)        | S(BP)         | R(G)       |R(BP)           |  S(R(G)) | S(R(BP)) | R(S(G)) | R(S(BP))  |   M   |
|---------:|------------------:|--------------------:|-------------------------:|------------------------:|-----------------------------:|-----------------------------:|----------------------------------:|-----------------------------:|----------------------------------:|------------:|
|    964.9 |             10629 |               824.2 |                   1146.8 |                   794.1 |                        797.8 |                        742.1 |                             **729.8** |                        747.9 |                             764.7 |       768.3 |
